                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $order_query = "SELECT o.id as oid, o.tracking_no, o.user_id, oi.*, oi.qty as orderqty, p.* FROM orders o, orders_items oi, 
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <image src="../uploads/<?= $items['image']; ?>" width="50px" height="50px"
                                                alt="<?= $items['name']; ?>">
                                                <?= $items['name']; ?>
                                        </td>
                                        <td class="align-middle">
                            ...
                            <div class="border mb-3">
                                <form action="code.php" method="POST">
                                    ...
                                    <button type="submit" name="update_order_btn" class="btn btn-primary mt-2">Update
                                        Status</button>
                                </form>
                            </div>
                        </div>
