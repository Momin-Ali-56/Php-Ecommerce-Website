                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <img src="../uploads/<?= $data['image'];?>" height="50px" width="50px" alt="" style="margin-top: 10px;">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" type="text" name="meta_description" placeholder="Enter meta description" class="form-control"><?= $data['meta_description']; ?></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label for="">Meta Keywords</label>
                                    <textarea rows="3" type="text" name="meta_keywords" placeholder="Enter meta keywords" class="form-control"><?= $data['meta_keywords']; ?></textarea>
                                </div>
                                <div class="col-md-6">
