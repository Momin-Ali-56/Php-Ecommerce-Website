...
if(isset($_POST['add_category_btn'])){
    ...
    if($name != '' && $slug != '' && $small_description != '' && $description != '' && $original_price != '' && $selling_price != '' && $qty != '' && $status != '' && $trending != ''){
    ...
    $_SESSION['message'] = "Orders Status Updated Successfully";
